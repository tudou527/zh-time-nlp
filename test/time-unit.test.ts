...
describe('TimeUnit', () => {
  test.skip('normal', () => {
    [
      ...
      console.log('%s => %s', str, nlp(str, { baseTime: '2019-12-31 19:00' })),
    );
  });
      ...
      describe('跨月', () => {
        test('月份最后一天', () => {
          const timeUnit = new TimeUnit(
            '5点1分',
            false,
            new Date('2019-10-31 19:00'),
          );
          const result = timeUnit.timeNormalization();
          expect(result).toBe('2019-11-01 05:01:00');
        });
        ...
        test('最后一个月', () => {
          const timeUnit = new TimeUnit(
            '5点1分',
            false,
            new Date('2019-12-31 19:00'),
          );
          const result = timeUnit.timeNormalization();
          expect(result).toBe('2020-01-01 05:01:00');
        });
      });
    });
  });
